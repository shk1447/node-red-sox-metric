module.exports = function (RED) {
  ...
  function SoxMetric(n) {
    ...
    if (RED.settings.httpNodeRoot !== false) {
      ...
      this.titleCaption = n.titleCaption;
      this.titleColor = n.titleColor;
      ...
      this.callback = function (req, res) {
        ...
        node.send({ _msgid: msgid, req: req, res: createResponseWrapper(node, res), payload: { titleCaption: node.titleCaption, titleColor: node.titleColor, fontSize: node.fontSize } });
      };
  ...
  RED.nodes.registerType("sox-metric", SoxMetric);
}